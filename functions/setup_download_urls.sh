...
setup_download_urls() {
  ...
  containernetworking="https://github.com/containernetworking/plugins/releases/download/v${containernetworking}/cni-plugins-linux-${ARCH}-v${containernetworking}.tgz"
