...
setup_download_urls() {
  ...
  containernetworking="https://github.com/containernetworking/plugins/releases/download/v${containernetworking_version}/cni-plugins-linux-${ARCH}-v${containernetworking_version}.tgz"
